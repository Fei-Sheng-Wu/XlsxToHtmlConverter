        ...
        public static string ConvertXlsx(Stream stream, ConverterConfig config, EventHandler<ConverterProgressCallbackEventArgs> progressCallbackEvent)
        {
            try
            {
                ...
                using (SpreadsheetDocument document = SpreadsheetDocument.Open(stream, true))
                {
                    ...
                    progressCallbackEvent?.Invoke(document, new ConverterProgressCallbackEventArgs(0, sheets.Count()));
                    ...
                    foreach (uint sheetId in sheetIds)
                    {
                        ...
                        progressCallbackEvent?.Invoke(document, new ConverterProgressCallbackEventArgs(sheets.TakeWhile(x => x != currentSheet).Count() + 1, sheets.Count()));
                    }
                }
...
<body>
    ...
    public class ConverterConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConverterConfig"/> class with specific page title.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConverterConfig"/> class with specific preset styles and error message.
        /// </summary>
